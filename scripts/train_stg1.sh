...
python train_stg1.py --model ORIG_STG1 --experiment sgd_trueWD_restart \
	--endEpoch 10 --loadPath ORIG_STG1_adam_trueWD_restart \
	--chunkSize 100 --batchSize 100 \
	--optim sgd --trueWD 1e-4 --lr 1e-1 \
	--lrSched restart --T_0 10 --T_mult 2 --lrBase 5e-5 \
	--gpu 0

# python train_stg1.py --model ORIG_STG1 --experiment sgd_trueWD_restart --endEpoch 10 --loadPath ORIG_STG1_adam_trueWD_restart --chunkSize 100 --batchSize 100 --optim sgd --trueWD 1e-4 --lr 1e-1 --lrSched restart --T_0 10 --T_mult 2 --lrBase 5e-5 --gpu 0